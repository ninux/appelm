...
eps_0 = 8.854187817e-12;          % [As/Vm] permittivity of free space  
mu_0  = 4*pi*1e-7;                % [H/m]   permeability of free space    
c     = 1/sqrt(mu_0*eps_0);       % [m/s]   speed of light 

%% Define problem geometry and parameters
domain_size          = 1;                       % [m]     1D problem space length
dx                   = 1e-3;                    % [m]     cell size   
dt                   = 3e-12;                   % [s]     duration of time step 
...
%     \underbrace{
%       \frac{
%         2 \epsilon_0 \epsilon_r - \Delta t \sigma
%       }{
%         2 \epsilon_0 \epsilon_r + \Delta t \sigma
%       }
%     }_{\mathrm{Ceze}}
